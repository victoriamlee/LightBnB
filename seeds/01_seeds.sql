...
VALUES (1, 'Pool House', 'description', 'url', 'url', 300, 5, 4, 8, 'Canada', 'Bayview', 'Richmondhill', 'Ontario', 'L8F9F3', true),
(2, 'Spa House', 'description', 'url', 'url', 200, 4, 3, 6, 'Canada', 'Yonge', 'North York', 'Ontario', 'L6M2M6', true),
(3, 'Gym House', 'description', 'url', 'url', 250, 2, 2, 4, 'Canada', 'Kennedy', 'Markham', 'Ontario', 'L4F6O3', true);
